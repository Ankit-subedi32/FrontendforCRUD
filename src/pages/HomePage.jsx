...
function HomePage() {
    return (
        <>
       <div className="h-screen w-full overflow-y-scroll bg-black dark:bg-gray-200">
  <nav className="w-full sm:w-10/12 lg:w-8/12 mx-auto relative z-10 flex items-center justify-between dark:bg-white bg-black/80 md:mt-10 py-4 text-white dark:text-black border-b border-green-600/20 dark:border-green-600/20 shadow-lg shadow-green-400/20">
    {/* <div class="">
      <h4 class="text-4xl font-serif text-white dark:text-black px-4 py-1">Samuel</h4>
  </div> */}
    <div className="flex-shrink-0 px-4">
      <a href="#" className="text-xl font-bold text-gray-700">
        ...
        <span className="px-1 bg-green-400 rounded-full animate-[ping_2.1s_linear_infinite]">M</span>
        <span className="px-1 bg-green-400 rounded-full animate-[ping_2.2s_linear_infinite]">U</span>
    ...
    <ul className="hidden text-lg md:flex w-1/2 items-center justify-between gap-4 py-2 cursor-pointer md:px-10 border-r-2 border-l-2 border-gray-800 dark:border-gray-300">
      <li className="rounded-b border-b-[3px] border-green-600">Home</li>
      <li className="rounded-b hover:border-b-[3px] hover:border-green-600">Service</li>
      <li className="rounded-b hover:border-b-[3px] hover:border-green-600">About</li>
      <li className="rounded-b hover:border-b-[3px] hover:border-green-600">Pricing</li>
    </ul>
    <div className="hidden md:flex justify-start pl-4 pr-2 py-1">
      <a href="mailto:samuelabera87@gmail.com" className="bg-green-600 text-white px-6 py-2 rounded-md relative overflow-hidden group">
        <span className="absolute top-0 left-0 w-full h-full bg-white opacity-20 transform -skew-x-12 -translate-x-full group-hover:translate-x-0 transition duration-500" />
        <span className="relative z-10 font-bold text-gray-800">Hire Me</span>
      </a>
    </div>
    {/* TOGGLE BUTTONS */}
    <button className="block md:hidden text-3xl pr-4" id="nav__toggle-open">
      <i className="uil uil-bars" />
    </button>
    <button className="hidden md:hidden text-3xl pr-4" id="nav__toggle-close">
      <i className="uil uil-multiply" />
    </button>
    {/* Mobile NAv */}
    <ul id="mobile-nav" className="hidden md:hidden sm:w-full w-[98%] mx-auto absolute top-[4rem] left-0 right-0 w-full flex-col items-center gap-4 bg-black dark:bg-white rounded-b cursor-pointer shadow shadow-green-600">
      <li className="p-2 rounded shadow shadow-green-600">Home</li>
      <li className="p-2 rounded hover:shadow hover:shadow-green-600">Service</li>
      <li className="p-2 rounded hover:shadow hover:shadow-green-600">About</li>
      <li className="p-2 rounded hover:shadow hover:shadow-green-600">Pricing</li>
  ...
  <div className="w-[90%] md:w-[88%] mx-auto flex gap-6 items-center text-white dark:text-black justify-between pb-20 mt-12 md:mt-24">
    ...
    <div className="w-full flex flex-col gap-6 py-10 md:py-0">
      ...
      <p className="sm:text-lg text-md">Experienced full-stack developer with 5+ years of expertise in
        Laravel, NestJS and
        Nuxt.js experience.</p>
      <div className="flex gap-2">
        ...
        <button className="relative text-gray-200 dark:text-black px-6 py-2 rounded-md overflow-hidden group">
          <span className="absolute inset-0 bg-green-600 transform -translate-x-full group-hover:translate-x-0 transition duration-300" />
      ...
      <div className="flex items-center sm:gap-10 gap-6">
        <div className="flex flex-col gap-1">
          <h4 className="text-xl sm:text-3xl font-bold">5 <sup className="font-bold -ml-1">+</sup>
          </h4>
          <p className="text-sm sm:text-base text-gray-300 dark:text-gray-800">Years Expireance</p>
        </div>
        <div className="flex flex-col gap-1">
    ...
    <div className="xl:w-1/2 w-full flex items-center justify-center hidden lg:block">
      <div className="relative bg-black border border-none dark:border-gray-300 rounded-lg p-2 dark:bg-white">
        <img className="h-[80%] object-center object-cover" src="https://techakim.com/sam/tg/7268/li/imgs/2.png" alt="Portfolio Image" />
        {/* 1 */}
        <div className="absolute bg-green-600 text-gray-800 shadow-md shadow-green-600 animate-bounce px-2 py-1 rounded top-10 -left-10 border border-gray-400 z-10">
          <div className="flex gap-1 items-center">
            <svg className="w-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" id="mobile">
              <path fill="#88a1ba" d="M37 32H5c-1.1 0-2-.9-2-2V10c0-1.1.9-2 2-2h32c1.1 0 2 .9 2 2v20c0 1.1-.9 2-2 2z">
              </path>
              <path fill="#f7f7fb" d="M37 32H5c-1.1 0-2-.9-2-2v-4h36v4c0 1.1-.9 2-2 2z" />
              <path fill="#444a54" d="M24 41h-6a1 1 0 0 1-1-1v-8a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1zm-5-2h4v-6h-4v6z">
              </path>
              <path fill="#f7f7fb" d="M18 32h6v8h-6z" />
              <circle cx={21} cy={29} r={1} fill="#444a54" />
              <path fill="#444a54" d="M37 7H5c-1.654 0-3 1.346-3 3v20c0 1.654 1.346 3 3 3h12v6h-5.5a1 1 0 0 0 0 2h19a1 1 0 1 0 0-2H25v-6h12c1.654 0 3-1.346 3-3V10c0-1.654-1.346-3-3-3zM4 10c0-.551.449-1 1-1h32c.552 0 1 .449 1 1v15H4V10zm19 29h-4v-6h4v6zm15-9c0 .551-.448 1-1 1H5c-.551 0-1-.449-1-1v-3h34v3z">
              </path>
              <path fill="#f7f7fb" d="M43 40h-8a2 2 0 0 1-2-2V20a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v18a2 2 0 0 1-2 2z" />
              <path fill="#88a1ba" d="M33 22h12v14H33z" />
              <path fill="#444a54" d="M43 17h-8c-1.654 0-3 1.346-3 3v18c0 1.654 1.346 3 3 3h8c1.654 0 3-1.346 3-3V20c0-1.654-1.346-3-3-3zm-9 6h10v12H34V23zm0-3c0-.551.448-1 1-1h8c.552 0 1 .449 1 1v1H34v-1zm10 18c0 .551-.448 1-1 1h-8c-.552 0-1-.449-1-1v-1h10v1z">
              </path>
            </svg>
        ...
        <div className="absolute bg-green-600 text-gray-800 shadow-md shadow-green-600 animate-bounce px-2 py-1 rounded bottom-20 -left-14 border border-gray-400 z-10">
          <div className="flex gap-1 items-center">
            <svg className="w-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" id="setting-mobile">
              <g>
                <path fill="#9fdbf3" d="M11 7h26v34H11z" />
                <path fill="#b2e5fb" d="M14 7v9a23 23 0 0 0 23 23c.1 0 0 1.2 0-32Z" />
                <path fill="#374f68" d="M37 3v4H11V3a2 2 0 0 1 2-2h22a2 2 0 0 1 2 2Z" />
                <path fill="#425b72" d="M37 3v2H18a4 4 0 0 1-4-4h21a2 2 0 0 1 2 2Z" />
                <path fill="#374f68" d="M37 41v4a2 2 0 0 1-2 2H13a2 2 0 0 1-2-2v-4Z" />
                <path fill="#425b72" d="M37 41v4H18a4 4 0 0 1-4-4Z" />
                <path fill="#edebf2" d="M27 5h-6a1 1 0 0 1 0-2h6a1 1 0 0 1 0 2zm-2 40h-2a1 1 0 0 1 0-2h2a1 1 0 0 1 0 2zM17 5a1 1 0 0 1-.38-1.92A1 1 0 1 1 17 5z">
                </path>
                ...
                <path fill="#f26674" d="M33 25.5v-3l-2.31-.58a7.59 7.59 0 0 0-.49-1.17l1.22-2.05-2.12-2.12-2.05 1.22a7.59 7.59 0 0 0-1.17-.49L25.5 15h-3l-.58 2.31c-1.64.52-.65.8-2.43-.26A9 9 0 0 0 26 30.94c.11-.47-.15 0 1.23-.74l2.05 1.22 2.12-2.12-1.2-2.05a7.59 7.59 0 0 0 .49-1.17ZM24 27a3 3 0 1 1 3-3 3 3 0 0 1-3 3Z">
                </path>
                <path d="M35 0H13a3 3 0 0 0-3 3v42a3 3 0 0 0 3 3h22a3 3 0 0 0 3-3V3a3 3 0 0 0-3-3ZM12 8h24v32H12Zm0-5a1 1 0 0 1 1-1h22a1 1 0 0 1 1 1v3H12Zm24 42a1 1 0 0 1-1 1H13a1 1 0 0 1-1-1v-3h24Z">
                </path>
                <path d="M27 3h-6a1 1 0 0 0 0 2h6a1 1 0 0 0 0-2zm-4 42h2a1 1 0 0 0 0-2h-2a1 1 0 0 0 0 2zM17.92 3.62A1 1 0 1 0 17 5a1 1 0 0 0 .92-1.38zM24 20a4 4 0 1 0 4 4 4 4 0 0 0-4-4zm0 6a2 2 0 1 1 2-2 2 2 0 0 1-2 2z">
                </path>
            ...
            <h3 className="font-bold">Mobile App Dev't</h3>
          </div>
        </div>
      </div>
    </div>
